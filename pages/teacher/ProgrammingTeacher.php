...
$queryuploads = mysqli_query($conn, "select * from upload where course_type='programming' and teacher_id='$teacher_info[id]'");
?>
    ...
    <div class="row no-gutters">
        <div class="col-12 col-sm-6 col-md-8">
            ...
            <form enctype="multipart/form-data" id="file_form" method="POST" action="upload_file.php" class="mb-2">
                ...
                <input type="hidden" name="course" value="programming">
